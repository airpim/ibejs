...
//use SHA512 first 160 bits
function ibe_hash(str)
{
	return SHA512(str).substring(0,40)
}
...
//generate secret Key for ID
function extract_secret_key(id)
{
	var Q_id = G1_from_hash(id)
	//server secret s.
        //Should be kept Safely
	var s = str2bigInt("10681007545619528139211807714513200280572961850194771052062491085370",10,0)
	var k = 4
	var d_id = element_pow_wind_extract(Q_id,s)	

	//json version secret key ret

	var ret="var d_id = array_to_G1("+g12str(d_id) +");"
	return Base64.encode(ret)
}

var a=extract_secret_key(process.argv[2])
console.log(a)
